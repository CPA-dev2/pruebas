...
# Almacenamiento de resultados (opcional, pero recomendado para ver el estado)
...
# Agregamos http://192.168.1.247:5173 a la cadena por defecto
CSRF_TRUSTED_ORIGINS = os.getenv(
    'CSRF_TRUSTED_ORIGINS', 
    'http://localhost:5173,http://127.0.0.1:5173,http://192.168.1.247:5173,https://f11b465d02a7.ngrok-free.app'
).split(',')
...
CORS_ALLOWED_ORIGINS = [
    ...
    "https://ebd426ce8349.ngrok-free.app",  # <--- Agrega esta línea
]
